...
````{r}
# Estimate a 100-year return level for var2 for 2020. 
T_2020 = 31 * 10 # in 10 years, we have T days in January
...
x_T 
# 10 year return level for daily January temperatures is estimated at 18.2 degrees Celsius.
